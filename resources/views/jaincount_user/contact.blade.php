...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="publis/css3/animate.css">
...
<div class="container-fluid feedback">
  <div class="container" style="padding:0 90px !important;">
    
  <div class="headingtitle"><h1>Contact us</h1></div>
  ...
  <form action="contactadd" method="post">
    ...
    <div class="form-group">
      ...
      <input type="telephone" class="form-control" id="mobile" placeholder="Enter mobile" name="mobile" required="">
    </div>
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
  ...
  <div class="address">
    ...
    <ul>
      <h3>mumbai:</h3>
      <li><span><i class="fa fa-map-marker" aria-hidden="true"></i></span>307, Rajsheela Apt;597, J.S.S Marg. Chira Bazar Mumbai-400002 Maharastra, India</li>
      <h3>ahmedabad:</h3>
      <li><span><i class="fa fa-map-marker" aria-hidden="true"></i></span>4, Sanidhya Complex, Near Sanayas Aashram , Ashram Road Ahmedabad Gujarat, India </li>
    </ul>
  </div>
  <div class="email">
    <h1>email</h1>
