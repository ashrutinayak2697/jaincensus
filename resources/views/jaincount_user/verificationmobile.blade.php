...
$(document).ready(function()
{
  ...
  $("#send").click(function()
  {
    ...
    $.ajax({
      url: 'demo2',
      type:'post',
      data: {'_token': token ,'drpcode':drpcode,'txtnumber':number},
      dataType: 'JSON',
...
<li class="dropdown" class="active">
    ...
    <ul class="dropdown-menu">
      <li class="active"><a href=" {{url('otpverifymobile')}}">Edit Profile Mobile Number</a></li>
...
<div class="conatiner">
   ...
   <div class="col-md-6 col-sm-12">
        ...
        <div class="cont">
          ...
          <form method="post" action="{{ route('otpverifymobile') }}" id="l" style="display: none;">
            @csrf
