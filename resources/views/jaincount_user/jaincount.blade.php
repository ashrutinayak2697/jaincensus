...
if (document.getElementById("txtmobileno").value.trim()=="")
  ...
  // if (document.getElementById("txtbirth").value.trim()=="")
  // {
  //   document.getElementById('txtdate_err').innerHTML = 'required';
  //   var err_flag = false;
  //   } 
...
<ul class="nav navbar-nav navbar-right">
  ...
  <li class="active"><a href="{{ url('otp') }}">Register</a></li>
...
<div class="container">
  <div class="row">
    <div class="title text-center"><h1>Jain Census Registration Form</h1></div>
  ...
  <form  role="form" method="post" action="{{ route('jaincount') }}" enctype="multipart/form-data" class="form-inline" name="frmstf_add" id="frmstf_add" >
                 {{ csrf_field() }}
  ...
  <div class="row">
   <div class="col-sm-4">
    ...
    <select style="height: 36px;position: relative; width: 60px !important;" name="drpcode">
      ...
      @endforeach
      <input type="text" name="txtmobileno" placeholder="Enter Mobile" id="txtmobileno" onblur="onblur_validation('txtmobileno','txtmobileno_err','This filed is required');" style="width: 200px;position: absolute;" value="{{$mobile}}" readonly="">
    </select>
  </div>
   </div>
    <div class="col-sm-4 col-xs-12">
...
<div class="row">
      ...
      <div class="form-group">
        ...
        <input type="text" name="txtemail" placeholder="Enter Email" id="txtemail" value="{{$email}}" readonly="" />
      </div>
    </div>
    <div class="col-sm-4 col-xs-12">
      <div class="form-group">
        <label>Address</label><br/>
        <input type="text" name="txtaddress" placeholder="Enter Home No./street name" />
      </div>
    </div>
  <div class="col-sm-4 col-xs-12">
    <div class="form-group">
      <label>Landmark</label><br/>
      <input type="text" name="txtland" placeholder="Enter Landmark">
    </div>
  </div>
 </div> 
<div class="row">
    <div class="col-sm-4 col-xs-12">
    <div class="form-group">
      <label>Area <span style="color: red;">*</span></label> <b style="color:red;" ><label id="txtarea_err" class="error-validation errcustome"></label></b><br/>
      <input type="text" name="txtarea" placeholder="Enter Area" id="txtarea" onblur="onblur_validation('txtarea','txtarea_err','This filed is required');">
    </div>
  </div>
...
<div class="row">
  <div class="col-sm-4 col-xs-12">
    <div class="form-group">
      <label>City <span style="color: red;">*</span></label><b style="color:red;" ><label id="city_err" class="error-validation errcustome"></label></b><br/>
      <input type="text"name="city" placeholder="Enter City Name" id="city"   onblur="onblur_validation('city','city_err','This filed is required');">
    </div>
  </div>
  ...
  <div class="col-sm-4 col-xs-12">
    <div class="form-group">
      ...
      <input type="text" name="txtpincode" placeholder="Enter  Postalcode/Zipcode" id="txtpincode" onblur="onblur_validation('txtpincode','txtpincode_err','This filed is required');">
    </div>
  </div>
    <div class="col-sm-4 col-xs-12">
    <div class="form-group">
      <label for="inputCity">Sampraday</label> <b style="color:red;" ><label id="state_err" class="error-validation errcustome"></label></b><br/>
       <select style="height: 35px; width: 266px;" name="drpsampraday" onchange='CheckSampraday(this.value);'>
                ...
                <br/>
                <input type="text" name="sampraday" id="drpsampraday" style="display: none;" placeholder="Enter Your Sampraday">
    </div>
  </div>
</div>
<div class="row">
  <div class="col-xs-12">
    ...
    <p style="font-size: 15px; font-weight: 400;margin-top: 10px;"> <input type="checkbox" name="ch" hidden="hidden" checked="checked" > &nbsp;&nbsp;&nbsp;जैन संघ से संबंधित विविध गतिविधियोंके समाचार डिजिटल और प्रिंट मीडिया के माध्यमसे हमे मिलते रहेंगे यह हमे मान्य है|</p>
  </div>
</div>
