...
$(document).ready(function()
{
  ...
  $("#send").click(function()
  {
    ...
    $.ajax({
      url: 'demo1',
      type:'post',
      data: {'_token': token ,'txtemail':adhar,'drpcode':drpcode,'txtnumber':number},
      dataType: 'JSON',
   ...
   <div class="col-md-6 col-sm-12">
        ...
        <div class="cont">
          ...
          @endif
               ...
               <input type="text" name="txtemail" placeholder="Enter Your Email address" id="adhar">
               {{ csrf_field() }}
               </div>
               <div id="q">
               <label>Mobile Number</label>
              <select style="width: 52px;position: absolute;height: 40px;" name="drpcode" id='drp'>
                <option value="+91" checked>+91 IND </option>
                <option value="+61">+61 AUS </option>
                <option value="+44">+44  UK </option>
                <option value="+1">+1  USA </option>
            </select>
            <input type="text" name="txtnumber" class="mobile" placeholder="Enter Mobile Numbe" style="height: 40px;width: 90%;padding: 5px;position: relative;left: 50px;" id="number">
          ...
          <form method="post" action="{{ route('otpmsg') }}" id="l" style="display: none;">
            @csrf
